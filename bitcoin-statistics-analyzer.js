...
class BitcoinStatsAnalyzer {
  constructor() {
    ...
    this.API_KEY = 'CG-ir86dgGg2grJLz3v4VzxDH2h';
  }
  ...
  calculateStatistics() {
    ...
    const varianciaPopulacional = this.data.reduce((sum, value) => 
      sum + Math.pow(value - mediaAritmetica, 2), 0) / n;

    // 6. Variância Amostral
    const varianciaAmostral = this.data.reduce((sum, value) => 
      sum + Math.pow(value - mediaAritmetica, 2), 0) / (n - 1);
...
• Valor mínimo: $${stats.dadosBasicos.valorMinimo.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}
• Valor máximo: $${stats.dadosBasicos.valorMaximo.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}

📋 ESTATÍSTICAS CALCULADAS:
${'─'.repeat(30)}

🔢 MEDIDAS DE TENDÊNCIA CENTRAL:
• Média Aritmética: $${stats.estatisticas.mediaAritmetica.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}
• Mediana: $${stats.estatisticas.mediana.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}
• Moda: ${typeof stats.estatisticas.moda === 'number' ? '$' + stats.estatisticas.moda.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2}) : stats.estatisticas.moda}

📏 MEDIDAS DE DISPERSÃO:
• Amplitude: $${stats.estatisticas.amplitude.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}

📊 VARIÂNCIA:
• Variância Populacional: ${stats.estatisticas.varianciaPopulacional.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}
• Variância Amostral: ${stats.estatisticas.varianciaAmostral.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}

📈 DESVIO PADRÃO:
• Desvio Padrão Populacional: $${stats.estatisticas.desvioPadraoPopulacional.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}
